  ...
  <div class="container-fluid mt-3 mb-5">
    <div class="row">
      <div class="col-12">
        ...
        <p>
          ...
          <small><strong class="text-primary">Neue Bilder</strong> müssen aktuell händisch vorbereitet und hochgeladen werden. Dafür werden von jeder Aufnahme 4 Versionen hochgeladen, bei Artbildern, die im Banner erscheinen sollen, ist es eine Version. </small> <br>
    ...
    <div class="row">
      <div class="col-6 border-end">
        <h5>&bdquo;normale&ldquo; Artbilder (16:9)</h5>
      ...
      <div class="col-6">
        <h5>Artbild Banner (2:1)</h5>
        <ul class="checkedList">
            <li><small><strong>_2 </strong> - 1200x600 Pixel</small></li>
        </ul>
      </div>
    </div>
    <!-- <div class="row">
