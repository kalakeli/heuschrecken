...
class ProjectController extends Controller
{
    ...
    /**
     * Projekt aufgrund der URL abfragen
     */
    public function getProjectByURL($url)
    {
        $thePictures = $this->getPictures();
        $theItems = Project::select(\DB::raw('tblProjects.*, "" as theImg, "" as theImg_mi, "" as imgTitle, "" as imgPath, "" as imgFN, "" as copyrightTitle '))
            ->where('projectUrl', 'LIKE', $url)
            ->get();
     ...
     * x Projekte abfragen 
     */
    public function getProjects($nr)
    {
        $thePictures = $this->getPictures();
        $theItems = Project::select(\DB::raw('tblProjects.*, "" as theImg, "" as theImg_mi, "" as imgTitle, "" as imgPath, "" as imgFN, "" as copyrightTitle '))
    ...
    public function store(Request $request)
    {
        ...
        $theItem->projectTitle = $request->projectTitle;
        $theItem->projectTeaser = $request->projectTeaser;
        $theItem->projectText = $request->projectText;
        $theItem->projectUrl = $request->projectUrl;
    ...
    public function show(string $id)
    {
        ...
        $theItem = Project::select(\DB::raw('tblProjects.*, "" as theImg, "" as imgTitle, "" as imgPath, "" as imgFN, "" as copyrightTitle '))
            ->where('projectPKID', '=', $id)
            ->get()
            ->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $theItem->projectTitle = $params['projectTitle'];
        $theItem->projectTeaser = $params['projectTeaser'];
        $theItem->projectUrl = $params['projectUrl'];
        $theItem->projectText = html_entity_decode($params['projectText']);
